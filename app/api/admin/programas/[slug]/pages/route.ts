import { MissingCloudinaryConfigError, uploadProgramPages } from "@/lib/cloudinary";
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({ error: getErrorMessage(error, "No se pudieron subir las imágenes") }, { status: 500 });
  }
}
